    ...
    public class DebuggerVM : INotifyPropertyChanged 
    {
        ...
        public NESMachine DebugTarget
        {
            ...
            set
            {
                ...
                {
                    UpdateDebugInfo();
                    _breakpoints = new ObservableCollection<string>(
        ...
        private ObservableCollection<string> _breakpoints = null;

        public ObservableCollection<string> Breakpoints
        {
            get
            {
                return _breakpoints;
        ...
        public void AddBreakpoint(int address)
        {
            if (_nes != null)
            {
                ...
                Breakpoints.Add(string.Format("{0:x4}", newCPUBreakpoint.Address));
