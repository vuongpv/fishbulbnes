...
//                );
        ...
        public IUnityContainer RegisterNesTypes(IUnityContainer container, string nesType)
        {
            ...
            container.RegisterType<IWavStreamer, OpenALInlineWavStreamer>(new ContainerControlledLifetimeManager());
            
			// container.RegisterType<IWavStreamer, DummyWavStreamer>(new ContainerControlledLifetimeManager());
            // Select and setup the default PPU engine


			container.RegisterType<IControlPad, NullControlPad>("padone");
			container.RegisterType<IControlPad, NullControlPad>("padtwo");
