...
Number.prototype._netFormat = function Number$_netFormat(format, useLocale) {
    var nf = useLocale ? ss.CultureInfo.Current.numberFormat : ss.CultureInfo.Neutral.numberFormat;
...
Date.prototype._netFormat = function Date$_netFormat(format, useLocale) {
    var dtf = useLocale ? ss.CultureInfo.Current.dateFormat : ss.CultureInfo.Neutral.dateFormat;
    var useUTC = false;
